...
function paymentExpiringIn(milliseconds: number): CreatePaymentResponse {
...
function renderFlow(payment: CreatePaymentResponse) {
...
async function flushImmediateRequest(): Promise<void> {
  await act(async () => {
    await vi.advanceTimersByTimeAsync(0);
  });
}

function awaitingResponse(payment: CreatePaymentResponse): Response {
