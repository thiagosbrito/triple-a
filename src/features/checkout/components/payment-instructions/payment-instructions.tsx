    ...
    >
      <div className="grid gap-5 md:grid-cols-[minmax(0,1fr)_15rem]">
        <div>
          ...
          <p className="mt-4 font-mono text-3xl font-semibold tracking-tight break-all text-slate-950 sm:text-4xl">
            {totalDue} <span className="font-sans text-xl">{asset}</span>
          </p>
          <p className="mt-2 text-sm leading-6 text-slate-600">
            Use the{" "}
            <strong className="text-slate-950">{quote.network_name}</strong>{" "}
